...
atk.Button3d(f2, text='Button3', command=lambda m="#Text you want to show when\
            b1 is clicked": callback(m)).pack(pady=10)
...
#overlay bar
bar = atk.RadialProgressbar(f2, fg='red')
bar.pack(padx=30, pady=30)

atk.Button3d(f2, text='Button4').pack(pady=10)
